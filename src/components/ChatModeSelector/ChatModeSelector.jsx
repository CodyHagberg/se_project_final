...
function ChatModeSelector({ userName, onSelect, micError }) {
  return (
    <div className="modeSelector">
      <h2 className="modeSelectorTitle">
        Welcome, {userName}!
      </h2>
      <p className="modeSelectorSubtitle">
        How would you like to chat with our AI assistant?
      </p>
      {micError && (
