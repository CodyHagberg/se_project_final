...
const faqItems = [
  {
    question: "How is ALEI different from a standard chatbot?",
    answer:
      "Most chatbots are \"branching scripts\" that frustrate users with rigid menus. ALEI is an AI-powered Sales Assistant that understands industry-specific jargon and business context. Instead of just answering questions, ALEI proactively qualifies your leads by identifying their budget, timeline, and needs—delivering a \"ready-to-close\" profile to your team."
  },
  {
    question: "Can ALEI integrate with my existing CRM?",
    answer:
